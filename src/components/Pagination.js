...
const Pagination = ({pages, setCurrentPage, currentCompanys, sortedCompanys}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentCompanys.length}</b> out of <b>{sortedCompanys.length}</b> entries</div>
